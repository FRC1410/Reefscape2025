...
public final class Constants {
    ...
    public static int L_1_HEIGHT = 2; //1790
    ...
    public static double L1_ANGLE = 0.75; //0.564453
    public static double L2_ANGLE = 0.23;
    public static double L3_ANGLE = 0.25;
    public static double L4_ANGLE = 0.134; //0.447021
    public static double CORAL_OFF = 1.05;

    public static double INTAKE_ANGLE = 0.24; //0.171875
